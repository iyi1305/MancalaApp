...
public class MancalaDataStructure {
    private final int PlayerOne = 6;
    private final int PlayerTwo = 13;
    ...
    public int storePos(int playerNum) {
    ...
    private void setSkipPlayer(int playerNum) {
        ...
        playerSkip = PlayerTwo;
        if (playerNum == 2) {
            playerSkip = PlayerOne;
        }
    }
    ...
    /**
     * Retrieves the current position of the iterator in the Mancala data structure.
     * The iterator position is used to keep track of the current pit being processed 
     * during the game, especially during stone distribution and capturing processes.
     *
     * @return The current position of the iterator, representing a pit index.
     */
